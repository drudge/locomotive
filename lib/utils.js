...
exports.acceptsArray = function(types, str) {
    // accept anything when Accept is not present by passing types[0]
  return exports._accepts(type, str, types[0]);
};

exports._accepts = function(types, str, defaultValue) {
...
exports.acceptedViaArray = function(types, str) {
  return exports._accepts(type, str);
};
